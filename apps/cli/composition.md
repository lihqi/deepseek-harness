...
flowchart LR
  ...
  plugin_dsh_base_web_search_codex["web-search-codex<br/>@deepseek-ai/dsh-web-search-codex"]
  cfg --> plugin_dsh_base_web_search_codex
...
| `web-search-codex` | `@deepseek-ai/dsh-web-search-codex` |
